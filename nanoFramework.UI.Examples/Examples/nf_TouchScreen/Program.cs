...
namespace nf_TouchScreen
{
    ...
    public class MyTouchScreen : TouchScreen
    {
        ...
        {
            int width = DisplayControl.ScreenWidth;
            int height = DisplayControl.ScreenHeight;
            ...
            // of the architecture.
            Touch.Initialize(myTouchScreen);
        ...
        {
            TouchCoordinate ti = new TouchCoordinate();
            ti.X = e.Touches.X;
            ti.Y = e.Touches.Y;
        ...
        private void Run(TouchScreen touchScreen)
        {
            ...
            touchScreen.OnTouchGesture += new TouchGestureEventHandler(GestureChangedHandler);
