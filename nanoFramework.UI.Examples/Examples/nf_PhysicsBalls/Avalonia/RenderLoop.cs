...
namespace Avalonia.Rendering
{
    ...
    public class RenderLoop : IRenderLoop
    {
        ...
        private ArrayList _itemsCopy = new ArrayList();
        ...
        public RenderLoop(IRenderTimer timer, Dispatcher dispatcher)
        {
            _timer = timer;
        ...
        protected IRenderTimer Timer
        {
            ...
            get
            {
                return _timer ??= _timer ?? throw new InvalidOperationException("Cannot locate IRenderTimer.");
            }
        }
