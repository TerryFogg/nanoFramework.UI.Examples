    ...
    class RotateImage
    {
        ...
        public RotateImage(Bitmap fullScreenBitmap, Font DisplayFont)
        {
            ...
            try
            {
                ...
                Single diagonalLength = (float)Math.Sqrt((double)waterFall.Width * (double)waterFall.Width + (double)waterFall.Height * (double)waterFall.Height);
