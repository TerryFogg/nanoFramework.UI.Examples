...
using static nf_WpfDemoApplication.MySimpleWPFApplication;
    ...
    public class Controls
    {
        ...
        internal sealed class ScrollPanelDemo : PresentationWindow
        {
                ...
                : base(program)
            {
                ...
                _viewer = new TextScrollViewer(Resources.GetString(Resources.StringResources.ScrollableText), MySimpleWPFApplication.NinaBFont, Color.Black);
                ...
                Text title = new Text(MySimpleWPFApplication.NinaBFont, Resources.GetString(Resources.StringResources.ScrollableTextTitle));
        ...
        internal sealed class FreeDrawingDemo : PresentationWindow
        {
            ...
            public override void OnRender(DrawingContext dc)
            {
                ...
                // Draw some text.
                dc.DrawText(Resources.GetString(Resources.StringResources.DrawTextSample), Resources.GetFont(Resources.FontResources.NinaB), ColorUtility.ColorFromRGB(255, 255, 255), _random.Next(Width / 4), Height - 20);
        ...
        internal sealed class MenuItemPanel : Control
        {
            ...
            public MenuItemPanel(int width, int height)
            {
                ...
                _largeX = Resources.GetBitmap(Resources.BitmapResources.Canvas_Panel_Icon).Width + xOffsetSeparation;
            }
            ...
            public override void OnRender(DrawingContext dc)
            {
                ...
                if (_width > 0)
                {
                    ...
                    dc.DrawText(ref text, Resources.GetFont(Resources.FontResources.NinaB), Color.White, 10, row, _width - 20, step, TextAlignment.Center, TextTrimming.None);
