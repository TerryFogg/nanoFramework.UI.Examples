    ...
    public abstract class UIElement : DispatcherObject
    {
        ...
        private static void EnsureClassHandlers()
        {
            ...
            if (_classEventHandlersStore == null)
            {
                ...
                AddRoutedEventHandler(_classEventHandlersStore, TouchEvents.TouchGestureEvent, new RoutedEventHandler(UIElement.OnTouchGestureThunk), false);
        ...
        private static void OnTouchGestureThunk(object sender, RoutedEventArgs e) 
        { 
             ((UIElement)sender).OnTouchGesture((TouchEventArgs)e); 
        }
...
/// <param name="e"></param>
        ...
        /// </summary>
        /// <param name="e"></param>
        protected virtual void OnTouchGesture(TouchEventArgs e)
        {
       ...
       /// <param name="e"></param>
        ...
        /// 
        /// </summary>
        public event TouchEventHandler TouchGesture;
        /// <summary>
        /// 
        /// </summary>
