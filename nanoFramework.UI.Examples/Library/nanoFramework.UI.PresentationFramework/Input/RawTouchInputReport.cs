...
public class RawTouchInputReport : InputReport
    {
        ...
        public RawTouchInputReport(PresentationSource inputSource, DateTime timestamp, byte eventMessage, TouchCoordinate touches)
        ...
        public RawTouchInputReport(PresentationSource inputSource,
                    DateTime timestamp, byte eventMessage, TouchCoordinate touches, UIElement destTarget)
            : base(inputSource, timestamp)
        {
            EventMessage = eventMessage;
            Touches = touches;
        ...
        /// 
        /// </summary>
        public readonly TouchCoordinate Touches;
    }
